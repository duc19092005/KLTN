...
export default function ReceptionistIntakePage() {
  ...
  return (
    <DashboardLayout user={user} navItems={FRONTDESK_NAV_ITEMS} activeItem="patient-intake" onNavigate={(id) => navigate(frontdeskRouteFor(id))} onLogout={logout}>
      <div className="mx-auto max-w-[1600px] space-y-5 pb-12">
        <section className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-cyan-600">Tiếp nhận</p>
              <h1 className="mt-1 text-2xl font-black text-slate-950">Tạo lượt</h1>
            </div>
