export const VISIT_STATUS = {
  ...
  IN_PROGRESS: { label: 'Đang khám', shortLabel: 'Đang khám', color: 'bg-blue-50 text-blue-700 border-blue-200', dot: 'bg-blue-500' },
  WAITING_TEST_RESULT: { label: 'Chờ kết quả cận lâm sàng', shortLabel: 'Chờ CLS', color: 'bg-purple-50 text-purple-700 border-purple-200', dot: 'bg-purple-500' },
  WAITING_CONCLUSION: { label: 'Chờ kết luận', shortLabel: 'Chờ KL', color: 'bg-indigo-50 text-indigo-700 border-indigo-200', dot: 'bg-indigo-500' },
