...
function Hero({ totalLabel, onCreate }) { return <section className="rounded-[28px] border border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-cyan-50 p-8 shadow-sm flex flex-col lg:flex-row lg:items-end justify-between gap-5"><div><p className="text-[11px] font-black text-indigo-600 uppercase tracking-[0.24em] mb-3">Doctor OS</p><h2 className="text-3xl sm:text-4xl font-black text-slate-950 tracking-tight">Quản lý bác sĩ</h2><p className="mt-3 text-sm sm:text-base text-slate-600">Tạo mới đầy đủ tài khoản, hồ sơ nhân sự, chuyên khoa, chứng chỉ và phòng khám trong một bước.</p><span className="mt-4 inline-flex rounded-xl bg-white/80 px-3 py-1 text-xs font-black text-indigo-700 border border-indigo-100">{totalLabel}</span></div><div className="flex flex-wrap gap-3"><button onClick={onCreate} className="rounded-2xl bg-indigo-600 px-5 py-3 text-sm font-black text-white shadow-lg shadow-indigo-100 hover:bg-indigo-700">+ Thêm bác sĩ</button></div></section>; }
