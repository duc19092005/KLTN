 ...
 *
 * The on-chain layer already stores only Merkle roots, but these DB-side audit snapshots can still
 * leak PII/clinical text if callers pass raw domain objects. This sanitizer keeps identifiers,
 * statuses, hashes and schema metadata while removing free text, files, URLs and patient/staff PII.
 */
