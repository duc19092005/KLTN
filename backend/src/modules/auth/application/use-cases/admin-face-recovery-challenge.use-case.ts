...
@Injectable()
export class AdminFaceRecoveryChallengeUseCase {
  constructor(
  ...
  async execute(userId: string, tokenWalletAddress?: string) {
    ...
    if (!checkpoint) {
      throw new ServiceUnavailableException({
        ...
        message: 'Không tìm thấy bản phục hồi khuôn mặt Admin đã được neo trên blockchain.',
      });
    }
    ...
    await this.audit.write(userId, 'ADMIN_FACE_RECOVERY_CHALLENGE_ISSUED', 'User', userId, {
