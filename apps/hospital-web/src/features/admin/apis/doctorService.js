...
export const doctorService = {
  ...
  softDeleteMany: (ids) => api.post('/doctors/bulk/soft-delete', { ids }),
  restoreMany: (ids) => api.post('/doctors/bulk/restore', { ids }),
  permanentDeleteMany: (ids) => api.post('/doctors/bulk/permanent-delete', { ids }),
