...
| Слой | Стек | Роль |
|---|---|---|
| **[Backend](../applications/hospital-api/README.ru.md)** | NestJS, TypeScript, Prisma, PostgreSQL | Бизнес-логика, интеграция ИИ (дочерний процесс Python), обработка биометрии |
| **[Frontend](../applications/hospital-web/README.ru.md)** | React (Vite), Tailwind, React Router v6 | SPA для 4 ролей: Admin, Receptionist, Doctor, Lab Manager |
| **[Blockchain](../applications/audit-contracts/README.ru.md)** | Solidity, Hardhat, Ethers.js v6 | Журналы аудита и проверка целостности (только хеши и Merkle, без PII) |
...
Полное оглавление: [`docs/README.ru.md`](docs-index.ru.md).

### По темам

| Тема | Документы |
|---|---|
| **Архитектура** | [Backend Clean Architecture](../architecture/backend.md) · [File Structure](../architecture/backend-file-structure.md) · [Frontend UI](../architecture/frontend-ui-guidelines.md) |
| **Безопасность** | [Tiers & Anchoring Policy](../security/tiers-and-anchoring.md) · [Audit Logging](../security/audit-logging.md) |
| **Для ИИ-агентов** | [AGENTS.md](../agents/AGENTS.md) |
...
| Вопрос | Ответ |
|---|---|
| Что такое Tier A и Tier B step-up? | [docs/security/tiers-and-anchoring.md](../security/tiers-and-anchoring.md) |
| Когда якорение происходит сразу, а когда пакетом раз в 5 минут? | [docs/security/tiers-and-anchoring.md](../security/tiers-and-anchoring.md) |
...
Подробнее в [AGENTS.md](../agents/AGENTS.md).
