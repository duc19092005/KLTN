...
- `apps/hospital-api/src/infrastructure/audit/audit-hash.util.ts`
- `apps/hospital-api/src/infrastructure/audit/audit-encryption.util.ts`
- `apps/hospital-api/src/infrastructure/audit/merkle.util.ts`
- `apps/hospital-api/src/infrastructure/audit/audit-logger.service.ts`
- `apps/hospital-api/src/infrastructure/audit/audit-anchor.service.ts`
- `apps/hospital-api/src/infrastructure/audit/audit-artifact.service.ts`
- `apps/hospital-api/src/infrastructure/audit/audit-recovery-crypto.service.ts`
