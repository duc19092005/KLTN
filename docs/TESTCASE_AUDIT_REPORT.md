...
> [!IMPORTANT]
> Phạm vi đánh giá là source hiện tại trong `backend/`, `frontend/`, `mobile/`,
> `blockchain/` và toàn bộ 7 sheet của `_4.1 ManualTestV1.xlsx`.
...
|---|---|---|---|---|---|
| Staff authentication | Staff roles | Login, refresh/me, logout | `/auth/*` | `backend/src/modules/auth/controllers/auth.controller.ts` | Critical |
| First login | Staff roles | Đăng ký khuôn mặt trước đổi mật khẩu | `/authenticate`, `/change-password` | `frontend/src/routes/AppRoutes.jsx`; `auth.controller.ts` | Critical |
...
- `backend/src/modules/visit/application/policies/visit-transition.policy.ts`
- `backend/src/modules/clinical-decision/application/use-cases/create-medical-conclusion.use-case.ts`
- `frontend/src/routes/AppRoutes.jsx`
- `frontend/src/features/doctor/pages/DoctorQueuePage.jsx`
- `frontend/src/features/lab-manager/pages/LabOrdersPage.jsx`
- `frontend/src/features/admin/pages/AuditLogsPage.jsx`
- `frontend/src/features/admin/pages/DeletedRecordsPage.jsx`
- `mobile/src/apps/patient-portal/PatientPortalScreen.tsx`
- `blockchain/contracts/AuditAnchor.sol`
- `blockchain/contracts/FaceRegistry.sol`
